...
<body <?php body_class(get_field('add_class_body', get_the_ID())); ?> data-aos-options="{&quot;duration&quot;: 1000, &quot;once&quot;: true, &quot;offset&quot;: &quot;getVw(50, 120)&quot;}" data-lenis-options="{&quot;duration&quot;: 1.5, &quot;smoothWheel&quot;: true}" data-lenis-restore-scroll="true">
			...
			<div class="section-header">
				...
				<div class="header-main">
					<div class="header-contact">
						...
						<a class="item-contact phone-contact" href="tel:<?php echo esc_attr(str_replace(' ', '', $hotline)); ?>">
							<div class="icon"><span class="material-symbols-outlined">phone_in_talk</span></div>
							<div class="content"><span>Hotline</span><strong><?php echo esc_html($hotline); ?></strong></div>
						</a>
						<?php endif; ?>
						
						<?php $advise = get_field('header_advise', 'options'); if($advise): ?>
						<a class="item-contact advise-contact" href="tel:<?php echo esc_attr(str_replace(' ', '', $advise)); ?>">
							<div class="icon"><span class="material-symbols-outlined">support_agent</span></div>
							<div class="content"><span>Tổng đài</span><strong><?php echo esc_html($advise); ?></strong></div>
						</a>
						<?php endif; ?>
						
						<?php $emergency = get_field('header_emergency', 'options'); if($emergency): ?>
						<a class="item-contact emergency-contact" href="tel:<?php echo esc_attr(str_replace(' ', '', $emergency)); ?>">
							<div class="icon"><span class="material-symbols-outlined">ambulance</span></div>
							<div class="content"><span>Cấp cứu</span><strong><?php echo esc_html($emergency); ?></strong></div>
						</a>
						<?php endif; ?>
					</div>
