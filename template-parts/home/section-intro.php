				...
				<div class="item-grid-left">
					...
					<div class="image">
						<div class="img img-ratio ratio:pt-[346_631] zoom-img">
							...
							<?php if ($video_url): ?>
							<a class="btn btn-play" href="<?php echo esc_url($video_url); ?>" data-fancybox="data-fancybox" data-fancybox-options="{&quot;infinite&quot;:true}">
					...
					<div class="countup-content">
						<?php if (have_rows('intro_stats')): ?>
							...
							<div class="item-countup">
								...
								<div class="number-countup"><span data-countup-options="{&quot;number&quot;: <?php echo esc_attr($stat_num); ?>, &quot;duration&quot;: 3, &quot;padZero&quot;: false}"></span></div>
